...
layout = html.Div(
    [
        html.H1('Advanced Data Visualization', 
	            style = {'position': 'relative', 'width':' 16.04vw', 'height': '8.33vh', 'left': '4vw', 'top': '2vh',
        ...
        html.Div([
                    html.Img(src=pil_rings,  
                            style={'position': 'relative', 'left': '25vw', 'top': '15vh', 'width': '35%', 'height': '30%'}),
                    html.H1('The Olympics under a magnifying glass', 
			                style={'position': 'relative', 'width': '55vw', 'height': '9.33vh', 'left': '9vw', 'top': '19vh',
                                    'fontFamily': 'Cabin', 'fontStyle': 'normal', 'fontWeight': '700', 'fontSize': '8vh', 'lineHeight': '10vh', 
				                    'display': 'flex', 'alignItems': 'center', 'textAlign': 'center', 'letterSpacing': '0.05em', 'color': '#000000'} ),
                    html.H1('For Bettors and Competitors', 
			                style={'position': 'relative', 'width': '55vw', 'height': '9.33vh', 'left': '21vw', 'top': '22vh',
                                    'fontFamily': 'Cabin', 'fontStyle': 'normal', 'fontWeight': '700', 'fontSize': '5vh', 'lineHeight': '10vh', 
				                    'display': 'flex', 'alignItems': 'center', 'textAlign': 'center', 'letterSpacing': '0.05em', 'color': '#000000'} )
                    ], 
                    style = {'position': 'relative', 'width': '72vw','height': '88vh', 'left': '26vw', 'top': '-3vh', 'background': '#EEF1FA', 'borderRadius': '12px 0vh 0vh 12px'}),
		html.Div(
                [
                    html.Div(
                        [
				    ...
				    html.Img(src=pil_seta, style={'position': 'relative',  'transform':' translatey(-4vh)','width': '1.5vw', 'height': '3vh', 'left': '15vw'})     
